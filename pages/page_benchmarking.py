...
def page_benchmarking():
    ...
    def _co_trend(field_key):
        ...
        for y in all_years:
            ...
            result[y] = {
                ...
                "nat_gas": ii.nat_gas,
                # o.total_coal: granular when sub-types set, else coal_sub legacy
                "coal": o.total_coal,
    ...
    with tab_energy:
        ...
        col_map = {
            # Map FUEL_DEFS keys → exact column names in CONSOLIDATED_DF
            "nat_gas":     "Energy - Natural Gas",
            "coal":        "Energy - Total Coal",    # blended total = sum of sub-types
