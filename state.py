...
# ── All electricity-by-country columns ────────────────────────────────────────
# Sourced from conversion_data.py (extracted from the WBCSD TIP KPI Collection
# Tool workbook) — the full IEA country/region taxonomy, ~150 entries grouped
# into 8 macro-regions, replacing the old hardcoded 31-country placeholder list.
from conversion_data import (
    ELEC_ALL_COUNTRIES, ELEC_COUNTRY_COLS, ELEC_COUNTRY_REGIONS,
    _elec_col,
)
